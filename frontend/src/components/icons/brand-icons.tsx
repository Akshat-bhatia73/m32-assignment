/** Provider brand marks. Kept as inline SVGs (lucide has no brand logos) so the model picker
 * can show real OpenAI / Google identity. OpenAI is monochrome (inherits currentColor); Google
 * keeps its four brand colors for a subtle, recognizable pop. */
