...
ROUTER_SYSTEM = (
    ...
    "- 'comms': anything about EMAIL or the user's CALENDAR — draft/send a follow-up EMAIL; "
    "VIEW / CHECK / LIST the user's calendar, events, meetings, or schedule; SCHEDULE items / add "
    "them to the calendar; MOVE / RESCHEDULE / push back an event; RENAME an event; or "
    "CANCEL / REMOVE / DELETE an existing calendar event. Questions like 'what's on my calendar "
    "today?' are 'comms'.\n"
