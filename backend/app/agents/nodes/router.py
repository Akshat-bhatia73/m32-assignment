...
ROUTER_SYSTEM = (
    ...
    "- 'edit': a request to add, change, or remove board items — create/add a new task, reassign "
    "an owner, change a due date, rename, mark done/scheduled, or delete an item.\n"
    "- 'comms': a request to draft or send a follow-up EMAIL, to SCHEDULE items / add them to "
    "the calendar, or to MOVE / RESCHEDULE / push back an existing calendar event to a new time.\n"
